...
function EventCard({ event }) {
  ...
  return (
    <div className={`event-card flex flex-row items-center bg-[#F6F9FF] max-md:flex-col max-md:w-full max-md:items-center
    ...
    >
      ...
      {/* ✅ Event Image */}
      <div
        className="event-image w-[477px] h-[268px]  max-xl:w-[400px] max-lg:w-[300px] rounded-2xl bg-cover bg-center"
      ...
      <div className="EventDetails flex flex-col justify-between p-4 flex-grow h-full gap-[70px] max-xl:gap-[40px] max-lg:gap-[20px]">
        ...
        <div className="flex flex-row justify-between items-center mt-auto">
          ...
          <div className={`flex flex-row gap-2 items-center bg-[#4889F4]  
            ...
            {count>0 && <img className="w-[30.94px] h-[30.94px] max-xl:w-[24px] max-xl:h-[24px]" src={vector}/>}
            {count>1 && <img className="w-[30.94px] h-[30.94px] max-xl:w-[24px] max-xl:h-[24px]" src={vector}/>}
            {count>2 && <img className="w-[30.94px] h-[30.94px] max-xl:w-[24px] max-xl:h-[24px]" src={vector}/>}
            {count>3 && <img className="w-[30.94px] h-[30.94px] max-xl:w-[24px] max-xl:h-[24px]" src={vector}/>}
            {count>4 && <img className="w-[30.94px] h-[30.94px] max-xl:w-[24px] max-xl:h-[24px]" src={vector}/>}
